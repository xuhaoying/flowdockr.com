...
4. Edit tone and regenerate once
...
- Confidence to send output to client (self-reported 1-5)

## Exit Thresholds

- At least 4 of 5 users complete all tasks without moderator intervention
- Median time-to-first-output <= 120 seconds
- No unresolved P0 issues and <= 2 unresolved P1 issues before launch
