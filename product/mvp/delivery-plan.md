...
- Exit criteria: Decision made on whether to scale Scope first or activate multi-module rollout

## Detailed Day Plan (Week 1)

1. Day 1: Finalize IA, routes, and Scope Guard prompt contract
2. Day 2: Build Scope form and generation endpoint
3. Day 3: Build output UI with copy buttons and CTA to signup
4. Day 4: Publish `/guides/scope-creep` and `/templates/revision-policy`
5. Day 5: QA, mobile fixes, analytics validation, launch
