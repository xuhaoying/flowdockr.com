---
title: How To Reply When Client Says Too Expensive
description: Action-ready playbook for how to reply when client says too expensive: strategy summary, mistakes to avoid, and 3 copy-paste replies.
...
Freelancers search for **how to reply when client says too expensive** when a live deal is at risk. The goal is to keep relationship quality while protecting margin and delivery confidence.
...
I understand the constraint around how to reply when client says too expensive. I can keep quality intact by adjusting scope or timeline so we stay aligned on outcome.
