---
title: Client Asking For Price Reduction
description: Action-ready playbook for client asking for price reduction: strategy summary, mistakes to avoid, and 3 copy-paste replies.
...
Freelancers search for **client asking for price reduction** when a live deal is at risk. The goal is to keep relationship quality while protecting margin and delivery confidence.
...
I understand the constraint around client asking for price reduction. I can keep quality intact by adjusting scope or timeline so we stay aligned on outcome.
