  ...
  return (
    <section className="border-brand-lavender/25 space-y-3 rounded-2xl border bg-white p-5 shadow-sm shadow-slate-950/5">
      ...
      <p className="text-sm text-slate-700">
        A negotiation credit is used when you generate a client-facing response
        or strategy output. Most real situations use 2 to 3 credits because
        users usually compare multiple tones before sending a final reply.
      </p>
